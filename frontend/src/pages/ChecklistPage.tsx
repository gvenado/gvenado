...
export function ChecklistPage() {
  ...
  const photoRequired = currentTask?.requiereFoto
  const photoComplete = photoEvidence.analysisComplete
  const canCompleteTask = currentTask?.tipo === 'toggle' || currentTask?.tipo === 'numeric' || (photoRequired ? photoComplete : true)
