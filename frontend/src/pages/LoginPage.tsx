          ...
          <div className="bg-white rounded-2xl shadow-lg shadow-black/5 border border-[#E2E8F0] p-5">
            {listError && (
              <p className="text-[10px] text-amber-600 bg-amber-50 border border-amber-200 rounded-lg px-3 py-1.5 mb-3">
                Backend sin conexión — mostrando datos de prueba
              </p>
            )}
            ...
            <div className="relative">
              ...
              <button
                type="button"
                onClick={() => !loadingList && setDropdownOpen(o => !o)}
              ...
              {dropdownOpen && (
                <div className="absolute left-0 right-0 top-full mt-1 bg-white border border-[#E2E8F0] rounded-xl shadow-lg z-50 overflow-hidden max-h-60 overflow-y-auto">
                  {reponedores.map(r => (
                    <button
                      key={r.id}
                      type="button"
            ...
            <button
              type="button"
              onClick={handleStart}
              disabled={isNavigating || !selected || loadingList}
              className={cn(
