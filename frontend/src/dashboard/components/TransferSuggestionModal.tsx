      ...
      >
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-[#E5E7EB]">
          <div className="flex items-center gap-2.5">
            ...
            <h3 className="text-sm font-bold text-[#111827]">Suggested Transfer</h3>
          </div>
          <button
            onClick={onCancel}
        ...
        <div className="px-5 py-4 space-y-4">
          <div>
            <p className="text-[10px] font-semibold text-[#6B7280] uppercase tracking-wider mb-2">Source</p>
          ...
          <div>
            <p className="text-[10px] font-semibold text-[#6B7280] uppercase tracking-wider mb-2">Destination</p>
          ...
          <div>
            <p className="text-[10px] font-semibold text-[#6B7280] uppercase tracking-wider mb-2">Materials To Transfer</p>
          ...
          <div className="bg-[#F0FDF4] rounded-lg p-3 flex items-center gap-2 border border-[#BBF7D0]">
            ...
            <div>
              <p className="text-[10px] font-semibold text-[#16A34A]">Expected Recovery</p>
              <p className="text-xs font-bold text-[#111827]">7 Additional Days</p>
            </div>
          </div>
        </div>
